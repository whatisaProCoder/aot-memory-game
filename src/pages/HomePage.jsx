  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center h-full">
        ...
        <div className="mt-8 max-sm:mt-16 max-sm:mb-16 flex flex-row max-sm:flex-col items-center gap-4 bg-[#3535357b] backdrop-blur-2xl border-b border-[#323232] rounded-3xl p-4">
